...
<body id="page-top">
    <div id="wrapper" >
        <!-- Sidebar -->
        <ul class="navbar-nav shadow bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url('Admin/index') ?>">Data users</a>
                        <a class="collapse-item" href="<?= base_url('Admin/buatakun') ?>">Buat User</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url('Pendaftaran') ?>">Pasien Baru</a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseThree"
                    ...
                    <i class="fas fa-user"></i>
                    <span>Pasien Berobat</span>
                </a>
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url('Pendaftaran/pasien_berobat') ?>">Data Pasien</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
